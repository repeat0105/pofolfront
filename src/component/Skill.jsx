  ...
  return (
    <div className="skillcalss">
      ...
      <div className="flrowtext">
        <p>
          HTML5&nbsp;&nbsp;CSS3&nbsp;&nbsp;JAVASCRIPT&nbsp;&nbsp;SASS&nbsp;&nbsp;JQUERY&nbsp;&nbsp;FIGMA&nbsp;&nbsp;GITHUB&nbsp;&nbsp;REACT&nbsp;&nbsp;REDUX&nbsp;&nbsp;TYPESCRIPT&nbsp;&nbsp;MONGODB&nbsp;&nbsp;CLOUDTYPE&nbsp;&nbsp;NEXT&nbsp;&nbsp;VERCEL&nbsp;&nbsp;NEXTAUTH&nbsp;&nbsp;KAKAOMAPAPI&nbsp;&nbsp;ZUSTAND&nbsp;&nbsp;VUE&nbsp;&nbsp;MYSQL
        </p>
      </div>
